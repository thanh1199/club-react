...
function Result ({ theme, data = "" }) {
    const dataAray = data.split(" ")
    const [teacher, subject, season] = dataAray
    return (
        <div id={clsx(teaching.result)} className={clsx(teaching[`result_${theme}`])}>
            {/* 
            ...
            */}
            <div id={clsx(teaching.part1)}>
                <div className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])} id={clsx(teaching.subject)}>
                    <span>科目名</span>
                    <span>{subject + " (" + season + ")"}</span>
                </div>
                <div className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])} id={clsx(teaching.teacher)}>
                    <span>担当先生</span>
                    <span>{teacher}</span>
                </div>
            </div>
            <div id={clsx(teaching.part2)}>
                <div id={clsx(teaching.part2a)}>
                    <div className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])} id={clsx(teaching.difficulty)}>
                        <span>難易度</span>
                        <span><DifficulityChart theme={theme}/></span>
                    </div>
                    <div className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])} id={clsx(teaching.text)}>
                        <span>テキスト</span>
                        <span>XXYYXXTT</span>
                    </div>
                    <div className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])} id={clsx(teaching.qualification)}>
                        <span>関連資格</span>
                        <span>MOS WORD expecialist</span>
                    </div>
                </div>
                <div id={clsx(teaching.part2b)} className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])}>
                    <span>成績割合</span>
                    <span style={{margin: "20px 0 0", padding: "unset"}}><QualificationChart theme={theme}/></span>
                </div>
            </div>
            <div id={clsx(teaching.part3)} className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])}>
                <span>内容</span>
            ...
            <div id={clsx(teaching.part4)} className={clsx(teaching.partUnit, teaching[`partUnit_${theme}`])}>
                <span>Comments</span>
